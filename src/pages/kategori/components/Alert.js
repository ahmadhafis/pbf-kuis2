...
class Alert extends Component {
    ...
    render() {
        ...
        if (resCode === 201 && actionType === 'created') {
            style = "alert alert-success shadow-lg"
            pesan = " Data Berhasil Di Simpan ..."
        } else {
            if (resCode === 200 && actionType === 'updated') {
                style = "alert alert-info shadow-lg"
                pesan = " Data Berhasil Di Update ..."
            } else {
                if (resCode === 200 && actionType === 'deleted') {
                    style = "alert alert-warning shadow-lg"
                    pesan = " Data Berhasil Di Hapus ..."
                } else {
                    style = "alert alert-error shadow-lg"
            ...
            <div>
                {showing
                    ...
                    <div id="notif" className={style}>
                        <span className="btn btn-sm" onClick={this.HideNotif}>&times;</span>
                        {pesan}
                    </div>
                    : null
                }
